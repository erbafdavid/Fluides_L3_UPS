...
\begin{figure}[htbp]
  ...
  \begin{tabular}{cc}
    ...
    \put(0.5,0.5){\includegraphics[width=4cm]{digue_perspective.eps}}
    \put(-0.5,4){(b)}
...
\begin{figure}[htbp]
  ...
  \begin{tabular}{cc}
    ...
    \put(0,3){(a)}
    \put(0,0){\includegraphics[width=6cm]{stable_equilibre.eps}}
    \put(1.2,0.1){$h$}
    ...
    \put(0,3.15){(b)}
    \put(0,0){\includegraphics[width=5.5cm]{stable_gitee.eps}}
    \put(0.9,0.2){$h$}
    \put(2.2,0.5){$\vec{P}$}
    \put(3.3,0.5){$\vec{R}$}
    ...
    \put(0,3.25){(d)}
    \put(0,0){\includegraphics[width=5.5cm]{instable_gitee.eps}}
    \put(0.7,0.4){$h$}
    \put(2.2,0.5){$\vec{R}$}
    \put(3.1,0.5){$\vec{P}$}
    \put(4.0,3){\textit{Couple de}}
...
% 
  ...
  \put(0,0.5){\includegraphics[width=6cm]{metacentre.eps}}
  \put(1.0,1.5){$h$}
  \put(2.5,1.7){$C$}
  \put(2.6,2.5){$G$}
  \put(3.7,1.7){$C'$}
